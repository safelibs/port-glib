...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct _GPortalNotificationBackend {
    pub parent: GNotificationBackend,
}
pub type GPortalNotificationBackend = _GPortalNotificationBackend;
pub type GPortalNotificationBackendClass = GNotificationBackendClass;
...
#[no_mangle]
pub unsafe extern "C" fn safe_c2rust_g_portal_notification_backend_get_type() -> GType {
    ...
    {
        let mut g_define_type_id: GType = safe_c2rust_g_portal_notification_backend_get_type_once();
        if 0 as ::core::ffi::c_int != 0 {
...
#[inline(never)]
unsafe extern "C" fn safe_c2rust_g_portal_notification_backend_get_type_once() -> GType {
    let mut g_define_type_id: GType = g_type_register_static_simple(
        g_notification_backend_get_type(),
        g_intern_static_string(b"GPortalNotificationBackend\0" as *const u8 as *const gchar),
        ::core::mem::size_of::<GPortalNotificationBackendClass>() as guint,
        ::core::mem::transmute::<Option<unsafe extern "C" fn() -> ()>, GClassInitFunc>(
            ::core::mem::transmute::<
                Option<unsafe extern "C" fn(gpointer) -> ()>,
                Option<unsafe extern "C" fn() -> ()>,
            >(Some(
                safe_c2rust_g_portal_notification_backend_class_intern_init
                    as unsafe extern "C" fn(gpointer) -> (),
            )),
        ),
        ::core::mem::size_of::<GPortalNotificationBackend>() as guint,
        ::core::mem::transmute::<Option<unsafe extern "C" fn() -> ()>, GInstanceInitFunc>(
            ::core::mem::transmute::<
                Option<unsafe extern "C" fn(*mut GPortalNotificationBackend) -> ()>,
                Option<unsafe extern "C" fn() -> ()>,
            >(Some(
                safe_c2rust_g_portal_notification_backend_init
                    as unsafe extern "C" fn(*mut GPortalNotificationBackend) -> (),
            )),
        ),
        G_TYPE_FLAG_NONE,
    );
...
unsafe extern "C" fn safe_c2rust_g_portal_notification_backend_class_intern_init(
    mut klass: gpointer,
) {
    safe_c2rust_g_portal_notification_backend_parent_class = g_type_class_peek_parent(klass);
    if safe_c2rust_GPortalNotificationBackend_private_offset != 0 as ::core::ffi::c_int {
        g_type_class_adjust_private_offset(
            klass,
            &raw mut safe_c2rust_GPortalNotificationBackend_private_offset,
        );
    }
    safe_c2rust_g_portal_notification_backend_class_init(
        klass as *mut GPortalNotificationBackendClass,
    );
}
static mut safe_c2rust_g_portal_notification_backend_parent_class: gpointer = NULL;
static mut safe_c2rust_GPortalNotificationBackend_private_offset: gint = 0;
unsafe extern "C" fn safe_c2rust_g_portal_notification_backend_is_supported() -> gboolean {
    return glib_should_use_portal();
}
unsafe extern "C" fn safe_c2rust_g_portal_notification_backend_send_notification(
    ...
    g_dbus_connection_call(
        ...
        b"/org/freedesktop/portal/desktop\0" as *const u8 as *const gchar,
        b"org.freedesktop.portal.Notification\0" as *const u8 as *const gchar,
...
unsafe extern "C" fn safe_c2rust_g_portal_notification_backend_withdraw_notification(
    mut backend: *mut GNotificationBackend,
    mut id: *const gchar,
) {
    g_dbus_connection_call(
        ...
        g_variant_new(b"(s)\0" as *const u8 as *const gchar, id),
        G_VARIANT_TYPE_UNIT,
        G_DBUS_CALL_FLAGS_NONE,
        -(1 as gint),
        ::core::ptr::null_mut::<GCancellable>(),
...
unsafe extern "C" fn safe_c2rust_g_portal_notification_backend_init(
    mut backend: *mut GPortalNotificationBackend,
) {
}
unsafe extern "C" fn safe_c2rust_g_portal_notification_backend_class_init(
    mut class: *mut GPortalNotificationBackendClass,
) {
    ...
    (*backend_class).is_supported = Some(
        safe_c2rust_g_portal_notification_backend_is_supported
            as unsafe extern "C" fn() -> gboolean,
    ) as Option<unsafe extern "C" fn() -> gboolean>;
    (*backend_class).send_notification = Some(
        safe_c2rust_g_portal_notification_backend_send_notification
    ...
    (*backend_class).withdraw_notification = Some(
        safe_c2rust_g_portal_notification_backend_withdraw_notification
