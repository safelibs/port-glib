...
pub type GDBusObjectInterface = GDBusObjectIface;
...
#[no_mangle]
pub unsafe extern "C" fn safe_c2rust_g_dbus_object_get_type() -> GType {
    ...
    }) != 0
    {
        let mut g_define_type_id: GType = g_type_register_static_simple(
            G_TYPE_INTERFACE,
            g_intern_static_string(b"GDBusObject\0" as *const u8 as *const gchar),
            ::core::mem::size_of::<GDBusObjectInterface>() as guint,
            ::core::mem::transmute::<Option<unsafe extern "C" fn() -> ()>, GClassInitFunc>(
                ::core::mem::transmute::<
                    Option<unsafe extern "C" fn(*mut GDBusObjectIface) -> ()>,
                    Option<unsafe extern "C" fn() -> ()>,
                >(Some(
                    safe_c2rust_g_dbus_object_default_init
...
unsafe extern "C" fn safe_c2rust_g_dbus_object_default_init(mut iface: *mut GDBusObjectIface) {
    g_signal_new(
...
#[no_mangle]
pub unsafe extern "C" fn safe_c2rust_g_dbus_object_get_object_path(
    mut object: *mut GDBusObject,
) -> *const gchar {
    let mut iface: *mut GDBusObjectIface = g_type_interface_peek(
        (*(object as *mut GTypeInstance)).g_class as gpointer,
        safe_c2rust_g_dbus_object_get_type(),
    ) as *mut GDBusObjectIface;
    return (*iface).get_object_path.expect("non-null function pointer")(object);
}
#[no_mangle]
pub unsafe extern "C" fn safe_c2rust_g_dbus_object_get_interfaces(
    mut object: *mut GDBusObject,
) -> *mut GList {
    let mut iface: *mut GDBusObjectIface = g_type_interface_peek(
        (*(object as *mut GTypeInstance)).g_class as gpointer,
    ...
    return (*iface).get_interfaces.expect("non-null function pointer")(object);
}
#[no_mangle]
pub unsafe extern "C" fn safe_c2rust_g_dbus_object_get_interface(
    mut object: *mut GDBusObject,
    ...
    return (*iface).get_interface.expect("non-null function pointer")(object, interface_name);
}
