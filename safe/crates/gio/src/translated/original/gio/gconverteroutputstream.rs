extern "C" {
    ...
    fn g_output_stream_is_closing(stream: *mut GOutputStream) -> gboolean;
...
unsafe extern "C" fn safe_c2rust_g_converter_output_stream_class_intern_init(mut klass: gpointer) {
    safe_c2rust_g_converter_output_stream_parent_class = g_type_class_peek_parent(klass);
    if safe_c2rust_GConverterOutputStream_private_offset != 0 as ::core::ffi::c_int {
        g_type_class_adjust_private_offset(
            klass,
            &raw mut safe_c2rust_GConverterOutputStream_private_offset,
        );
    }
    safe_c2rust_g_converter_output_stream_class_init(klass as *mut GConverterOutputStreamClass);
}
static mut safe_c2rust_GConverterOutputStream_private_offset: gint = 0;
#[inline]
unsafe extern "C" fn safe_c2rust_g_converter_output_stream_get_instance_private(
    mut self_0: *mut GConverterOutputStream,
) -> gpointer {
    return (self_0 as *mut guint8)
        .offset(safe_c2rust_GConverterOutputStream_private_offset as glong as isize)
        as gpointer;
}
static mut safe_c2rust_g_converter_output_stream_parent_class: gpointer = NULL;
#[inline(never)]
unsafe extern "C" fn safe_c2rust_g_converter_output_stream_get_type_once() -> GType {
    let mut g_define_type_id: GType = g_type_register_static_simple(
        g_filter_output_stream_get_type(),
        g_intern_static_string(b"GConverterOutputStream\0" as *const u8 as *const gchar),
        ::core::mem::size_of::<GConverterOutputStreamClass>() as guint,
        ::core::mem::transmute::<Option<unsafe extern "C" fn() -> ()>, GClassInitFunc>(
            ::core::mem::transmute::<
                Option<unsafe extern "C" fn(gpointer) -> ()>,
                Option<unsafe extern "C" fn() -> ()>,
            >(Some(
                safe_c2rust_g_converter_output_stream_class_intern_init
                    as unsafe extern "C" fn(gpointer) -> (),
            )),
        ),
        ::core::mem::size_of::<GConverterOutputStream>() as guint,
        ::core::mem::transmute::<Option<unsafe extern "C" fn() -> ()>, GInstanceInitFunc>(
            ::core::mem::transmute::<
                Option<unsafe extern "C" fn(*mut GConverterOutputStream) -> ()>,
                Option<unsafe extern "C" fn() -> ()>,
            >(Some(
                safe_c2rust_g_converter_output_stream_init
                    as unsafe extern "C" fn(*mut GConverterOutputStream) -> (),
            )),
        ),
        G_TYPE_FLAG_NONE,
    );
    safe_c2rust_GConverterOutputStream_private_offset = g_type_add_instance_private(
        g_define_type_id,
        ::core::mem::size_of::<GConverterOutputStreamPrivate>() as gsize,
    );
    let g_implement_interface_info: GInterfaceInfo = _GInterfaceInfo {
        ...
        >(::core::mem::transmute::<
            ...
            Option<unsafe extern "C" fn() -> ()>,
        >(Some(
            safe_c2rust_g_converter_output_stream_pollable_iface_init
...
#[no_mangle]
pub unsafe extern "C" fn safe_c2rust_g_converter_output_stream_get_type() -> GType {
    ...
    {
        let mut g_define_type_id: GType = safe_c2rust_g_converter_output_stream_get_type_once();
        if 0 as ::core::ffi::c_int != 0 {
...
unsafe extern "C" fn safe_c2rust_g_converter_output_stream_class_init(
    mut klass: *mut GConverterOutputStreamClass,
) {
    let mut object_class: *mut GObjectClass = ::core::ptr::null_mut::<GObjectClass>();
    let mut istream_class: *mut GOutputStreamClass = ::core::ptr::null_mut::<GOutputStreamClass>();
    object_class = klass as *mut ::core::ffi::c_void as *mut GObjectClass;
    (*object_class).get_property = Some(
        safe_c2rust_g_converter_output_stream_get_property
            as unsafe extern "C" fn(*mut GObject, guint, *mut GValue, *mut GParamSpec) -> (),
    )
        as Option<unsafe extern "C" fn(*mut GObject, guint, *mut GValue, *mut GParamSpec) -> ()>;
    (*object_class).set_property = Some(
        safe_c2rust_g_converter_output_stream_set_property
            as unsafe extern "C" fn(*mut GObject, guint, *const GValue, *mut GParamSpec) -> (),
    )
        as Option<unsafe extern "C" fn(*mut GObject, guint, *const GValue, *mut GParamSpec) -> ()>;
    (*object_class).finalize = Some(
        safe_c2rust_g_converter_output_stream_finalize as unsafe extern "C" fn(*mut GObject) -> (),
    ) as Option<unsafe extern "C" fn(*mut GObject) -> ()>;
    istream_class = klass as *mut ::core::ffi::c_void as *mut GOutputStreamClass;
    (*istream_class).write_fn = Some(
        safe_c2rust_g_converter_output_stream_write
        ...
        >;
    (*istream_class).flush = Some(
        safe_c2rust_g_converter_output_stream_flush
            as unsafe extern "C" fn(
                *mut GOutputStream,
                *mut GCancellable,
                *mut *mut GError,
...
unsafe extern "C" fn safe_c2rust_g_converter_output_stream_pollable_iface_init(
    mut iface: *mut GPollableOutputStreamInterface,
) {
    (*iface).can_poll = Some(
        safe_c2rust_g_converter_output_stream_can_poll
    ...
    (*iface).is_writable = Some(
        safe_c2rust_g_converter_output_stream_is_writable
            as unsafe extern "C" fn(*mut GPollableOutputStream) -> gboolean,
    )
        as Option<unsafe extern "C" fn(*mut GPollableOutputStream) -> gboolean>;
    (*iface).write_nonblocking = Some(
        safe_c2rust_g_converter_output_stream_write_nonblocking
            as unsafe extern "C" fn(
                *mut GPollableOutputStream,
                *const ::core::ffi::c_void,
                gsize,
    ...
    (*iface).create_source = Some(
        safe_c2rust_g_converter_output_stream_create_source
...
unsafe extern "C" fn safe_c2rust_g_converter_output_stream_finalize(mut object: *mut GObject) {
    let mut priv_0: *mut GConverterOutputStreamPrivate =
        ::core::ptr::null_mut::<GConverterOutputStreamPrivate>();
    let mut stream: *mut GConverterOutputStream = ::core::ptr::null_mut::<GConverterOutputStream>();
    stream = object as *mut ::core::ffi::c_void as *mut GConverterOutputStream;
    priv_0 = (*stream).priv_0;
    g_free((*priv_0).output_buffer.data as gpointer);
    g_free((*priv_0).converted_buffer.data as gpointer);
    if !(*priv_0).converter.is_null() {
        g_object_unref((*priv_0).converter as gpointer);
    }
    (*(safe_c2rust_g_converter_output_stream_parent_class as *mut GObjectClass))
        .finalize
        .expect("non-null function pointer")(object);
}
unsafe extern "C" fn safe_c2rust_g_converter_output_stream_set_property(
    mut object: *mut GObject,
    mut prop_id: guint,
    mut value: *const GValue,
    mut pspec: *mut GParamSpec,
) {
    let mut cstream: *mut GConverterOutputStream =
        ::core::ptr::null_mut::<GConverterOutputStream>();
    cstream = object as *mut ::core::ffi::c_void as *mut GConverterOutputStream;
    match prop_id {
        1 => {
        ...
        _ => {
            ...
            g_log(
                ...
                b"%s:%d: invalid %s id %u for \"%s\" of type '%s' in '%s'\0" as *const u8
                    as *const gchar,
                b"/home/yans/safelibs/pipeline/ports/port-glib/original/gio/gconverteroutputstream.c\0"
...
unsafe extern "C" fn safe_c2rust_g_converter_output_stream_get_property(
    mut object: *mut GObject,
    mut prop_id: guint,
...
unsafe extern "C" fn safe_c2rust_g_converter_output_stream_init(
    mut stream: *mut GConverterOutputStream,
) {
    (*stream).priv_0 = safe_c2rust_g_converter_output_stream_get_instance_private(stream)
        as *mut GConverterOutputStreamPrivate;
}
#[no_mangle]
pub unsafe extern "C" fn safe_c2rust_g_converter_output_stream_new(
    ...
    stream = g_object_new(
        safe_c2rust_g_converter_output_stream_get_type(),
...
unsafe extern "C" fn safe_c2rust_buffer_append(
    mut buffer: *mut Buffer,
    ...
    safe_c2rust_buffer_ensure_space(
        buffer,
        safe_c2rust_buffer_data_size(buffer).wrapping_add(data_size),
    );
    memcpy(
        (*buffer).data.offset((*buffer).end as isize) as *mut ::core::ffi::c_void,
        data as *const ::core::ffi::c_void,
        data_size as size_t,
    );
    (*buffer).end = (*buffer).end.wrapping_add(data_size);
}
unsafe extern "C" fn safe_c2rust_flush_buffer(
    ...
    if available > 0 as gsize {
        ...
        safe_c2rust_buffer_consumed(&raw mut (*priv_0).converted_buffer, nwritten);
        return res;
    }
    return TRUE;
}
unsafe extern "C" fn safe_c2rust_write_internal(
    ...
    let mut to_convert: *const ::core::ffi::c_char = ::core::ptr::null::<::core::ffi::c_char>();
    let mut to_convert_size: gsize = 0;
    let mut converted_bytes: gsize = 0;
    let mut converting_from_buffer: gboolean = 0;
    cstream = stream as *mut ::core::ffi::c_void as *mut GConverterOutputStream;
    priv_0 = (*cstream).priv_0;
    if safe_c2rust_flush_buffer(cstream, blocking, cancellable, error) == 0 {
        return -(1 as ::core::ffi::c_int) as gssize;
    }
    if (*priv_0).finished != 0 {
        return 0 as gssize;
    }
    if safe_c2rust_buffer_data_size(&raw mut (*priv_0).output_buffer) > 0 as gsize {
        converting_from_buffer = TRUE as gboolean;
        safe_c2rust_buffer_append(
            &raw mut (*priv_0).output_buffer,
            buffer as *const ::core::ffi::c_char,
            count,
        );
        to_convert = safe_c2rust_buffer_data(&raw mut (*priv_0).output_buffer);
        to_convert_size = safe_c2rust_buffer_data_size(&raw mut (*priv_0).output_buffer);
    } else {
        converting_from_buffer = FALSE as gboolean;
        to_convert = buffer as *const ::core::ffi::c_char;
        to_convert_size = count;
    }
    safe_c2rust_buffer_ensure_space(&raw mut (*priv_0).converted_buffer, to_convert_size);
    converted_bytes = 0 as gsize;
    while (*priv_0).finished == 0 && converted_bytes < to_convert_size {
        if safe_c2rust_buffer_tailspace(&raw mut (*priv_0).converted_buffer) == 0 as gsize {
            safe_c2rust_grow_buffer(&raw mut (*priv_0).converted_buffer);
        }
        my_error = ::core::ptr::null_mut::<GError>();
        res = g_converter_convert(
            (*priv_0).converter,
            to_convert.offset(converted_bytes as isize) as *const ::core::ffi::c_void,
            to_convert_size.wrapping_sub(converted_bytes),
            safe_c2rust_buffer_data(&raw mut (*priv_0).converted_buffer)
                .offset(safe_c2rust_buffer_data_size(&raw mut (*priv_0).converted_buffer) as isize)
            ...
            != G_CONVERTER_ERROR as ::core::ffi::c_int as ::core::ffi::c_uint
        {
            ...
            converted_bytes = converted_bytes.wrapping_add(bytes_read);
            if res as ::core::ffi::c_uint
        ...
        } else if converted_bytes > 0 as gsize {
            g_error_free(my_error);
            break;
        } else {
            if g_error_matches(
    ...
    if converting_from_buffer != 0 {
        safe_c2rust_buffer_consumed(&raw mut (*priv_0).output_buffer, converted_bytes);
        retval = count as gssize;
    } else {
        retval = converted_bytes as gssize;
    }
    safe_c2rust_flush_buffer(
        cstream,
        blocking,
        cancellable,
...
unsafe extern "C" fn safe_c2rust_g_converter_output_stream_write(
    mut stream: *mut GOutputStream,
    mut buffer: *const ::core::ffi::c_void,
    mut count: gsize,
    mut cancellable: *mut GCancellable,
    ...
    return safe_c2rust_write_internal(stream, buffer, count, TRUE, cancellable, error);
}
unsafe extern "C" fn safe_c2rust_g_converter_output_stream_flush(
    mut stream: *mut GOutputStream,
    mut cancellable: *mut GCancellable,
    mut error: *mut *mut GError,
) -> gboolean {
    ...
    if safe_c2rust_flush_buffer(cstream, TRUE, cancellable, error) == 0 {
        return FALSE;
    }
    safe_c2rust_buffer_ensure_space(&raw mut (*priv_0).converted_buffer, 1 as gsize);
    flushed = FALSE as gboolean;
    while (*priv_0).finished == 0 && flushed == 0 {
        if safe_c2rust_buffer_tailspace(&raw mut (*priv_0).converted_buffer) == 0 as gsize {
            safe_c2rust_grow_buffer(&raw mut (*priv_0).converted_buffer);
        }
        my_error = ::core::ptr::null_mut::<GError>();
        res = g_converter_convert(
            (*priv_0).converter,
            safe_c2rust_buffer_data(&raw mut (*priv_0).output_buffer) as *const ::core::ffi::c_void,
            safe_c2rust_buffer_data_size(&raw mut (*priv_0).output_buffer),
            safe_c2rust_buffer_data(&raw mut (*priv_0).converted_buffer)
                .offset(safe_c2rust_buffer_data_size(&raw mut (*priv_0).converted_buffer) as isize)
                as *mut ::core::ffi::c_void,
            safe_c2rust_buffer_tailspace(&raw mut (*priv_0).converted_buffer),
            (if is_closing != 0 {
                ...
                G_CONVERTER_FLUSH as ::core::ffi::c_int
            }) as GConverterFlags,
            &raw mut bytes_read,
            &raw mut bytes_written,
            &raw mut my_error,
            ...
            != G_CONVERTER_ERROR as ::core::ffi::c_int as ::core::ffi::c_uint
        {
            (*priv_0).converted_buffer.end =
                (*priv_0).converted_buffer.end.wrapping_add(bytes_written);
            safe_c2rust_buffer_consumed(&raw mut (*priv_0).output_buffer, bytes_read);
            if res as ::core::ffi::c_uint
                == G_CONVERTER_FINISHED as ::core::ffi::c_int as ::core::ffi::c_uint
            {
                (*priv_0).finished = TRUE as gboolean;
            ...
            if is_closing == 0
                && res as ::core::ffi::c_uint
                    == G_CONVERTER_FLUSHED as ::core::ffi::c_int as ::core::ffi::c_uint
            {
                if ({
                    ...
                    != 0
                {
                    ...
                    g_assertion_message_expr(
                        ...
                        G_STRFUNC,
                        b"buffer_data_size (&priv->output_buffer) == 0\0" as *const u8
                            as *const ::core::ffi::c_char,
                    );
                }
                flushed = TRUE as gboolean;
            }
        } else if g_error_matches(
            my_error,
            g_io_error_quark(),
...
unsafe extern "C" fn safe_c2rust_g_converter_output_stream_can_poll(
    mut stream: *mut GPollableOutputStream,
) -> gboolean {
    let mut base_stream: *mut GOutputStream =
        (*(stream as *mut ::core::ffi::c_void as *mut GFilterOutputStream)).base_stream;
    return (({
        let mut __inst: *mut GTypeInstance = base_stream as *mut GTypeInstance;
        ...
        && g_pollable_output_stream_can_poll(
            base_stream as *mut ::core::ffi::c_void as *mut GPollableOutputStream,
        ) != 0) as ::core::ffi::c_int;
}
unsafe extern "C" fn safe_c2rust_g_converter_output_stream_is_writable(
    mut stream: *mut GPollableOutputStream,
) -> gboolean {
    let mut base_stream: *mut GOutputStream =
        (*(stream as *mut ::core::ffi::c_void as *mut GFilterOutputStream)).base_stream;
...
unsafe extern "C" fn safe_c2rust_g_converter_output_stream_write_nonblocking(
    mut stream: *mut GPollableOutputStream,
    mut buffer: *const ::core::ffi::c_void,
    mut count: gsize,
    mut error: *mut *mut GError,
) -> gssize {
    return safe_c2rust_write_internal(
...
unsafe extern "C" fn safe_c2rust_g_converter_output_stream_create_source(
    mut stream: *mut GPollableOutputStream,
    mut cancellable: *mut GCancellable,
) -> *mut GSource {
    let mut base_stream: *mut GOutputStream =
...
#[no_mangle]
pub unsafe extern "C" fn safe_c2rust_g_converter_output_stream_get_converter(
    mut converter_stream: *mut GConverterOutputStream,
) -> *mut GConverter {
