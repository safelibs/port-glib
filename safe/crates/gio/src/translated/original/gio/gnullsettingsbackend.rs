...
pub type GNullSettingsBackend = GSettingsBackend;
pub type GNullSettingsBackendClass = GSettingsBackendClass;
pub const NULL: *mut ::core::ffi::c_void = ::core::ptr::null_mut::<::core::ffi::c_void>();
#[no_mangle]
pub unsafe extern "C" fn safe_c2rust_g_null_settings_backend_get_type() -> GType {
    ...
    {
        let mut g_define_type_id: GType = safe_c2rust_g_null_settings_backend_get_type_once();
        if 0 as ::core::ffi::c_int != 0 {
...
#[inline(never)]
unsafe extern "C" fn safe_c2rust_g_null_settings_backend_get_type_once() -> GType {
    let mut g_define_type_id: GType = g_type_register_static_simple(
        g_settings_backend_get_type(),
        g_intern_static_string(b"GNullSettingsBackend\0" as *const u8 as *const gchar),
        ::core::mem::size_of::<GNullSettingsBackendClass>() as guint,
        ::core::mem::transmute::<Option<unsafe extern "C" fn() -> ()>, GClassInitFunc>(
            ::core::mem::transmute::<
                Option<unsafe extern "C" fn(gpointer) -> ()>,
                Option<unsafe extern "C" fn() -> ()>,
            >(Some(
                safe_c2rust_g_null_settings_backend_class_intern_init
                    as unsafe extern "C" fn(gpointer) -> (),
            )),
        ),
        ::core::mem::size_of::<GNullSettingsBackend>() as guint,
        ::core::mem::transmute::<Option<unsafe extern "C" fn() -> ()>, GInstanceInitFunc>(
            ::core::mem::transmute::<
                Option<unsafe extern "C" fn(*mut GNullSettingsBackend) -> ()>,
                Option<unsafe extern "C" fn() -> ()>,
            >(Some(
                safe_c2rust_g_null_settings_backend_init
                    as unsafe extern "C" fn(*mut GNullSettingsBackend) -> (),
            )),
        ),
        G_TYPE_FLAG_NONE,
    );
...
unsafe extern "C" fn safe_c2rust_g_null_settings_backend_class_intern_init(mut klass: gpointer) {
    safe_c2rust_g_null_settings_backend_parent_class = g_type_class_peek_parent(klass);
    if safe_c2rust_GNullSettingsBackend_private_offset != 0 as ::core::ffi::c_int {
        g_type_class_adjust_private_offset(
            klass,
            &raw mut safe_c2rust_GNullSettingsBackend_private_offset,
        );
    }
    safe_c2rust_g_null_settings_backend_class_init(klass as *mut GNullSettingsBackendClass);
}
static mut safe_c2rust_GNullSettingsBackend_private_offset: gint = 0;
static mut safe_c2rust_g_null_settings_backend_parent_class: gpointer = NULL;
unsafe extern "C" fn safe_c2rust_g_null_settings_backend_read(
...
unsafe extern "C" fn safe_c2rust_g_null_settings_backend_write(
    mut backend: *mut GSettingsBackend,
    mut key: *const gchar,
...
unsafe extern "C" fn safe_c2rust_g_null_settings_backend_write_one(
    mut key: gpointer,
    mut value: gpointer,
    mut data: gpointer,
) -> gboolean {
    if !value.is_null() {
        g_variant_unref(g_variant_ref_sink(value as *mut GVariant));
    }
    return FALSE;
}
unsafe extern "C" fn safe_c2rust_g_null_settings_backend_write_tree(
    mut backend: *mut GSettingsBackend,
    mut tree: *mut GTree,
    mut origin_tag: gpointer,
) -> gboolean {
    g_tree_foreach(
        tree,
        Some(
            safe_c2rust_g_null_settings_backend_write_one
...
unsafe extern "C" fn safe_c2rust_g_null_settings_backend_reset(
    mut backend: *mut GSettingsBackend,
    mut key: *const gchar,
    mut origin_tag: gpointer,
) {
}
unsafe extern "C" fn safe_c2rust_g_null_settings_backend_get_writable(
    mut backend: *mut GSettingsBackend,
    mut name: *const gchar,
) -> gboolean {
    return FALSE;
}
unsafe extern "C" fn safe_c2rust_g_null_settings_backend_get_permission(
    mut backend: *mut GSettingsBackend,
    mut path: *const gchar,
) -> *mut GPermission {
    return g_simple_permission_new(FALSE);
}
unsafe extern "C" fn safe_c2rust_g_null_settings_backend_init(
    mut memory: *mut GNullSettingsBackend,
) {
}
unsafe extern "C" fn safe_c2rust_g_null_settings_backend_class_init(
    mut class: *mut GNullSettingsBackendClass,
) {
    ...
    (*backend_class).read = Some(
        safe_c2rust_g_null_settings_backend_read
    ...
    (*backend_class).write = Some(
        safe_c2rust_g_null_settings_backend_write
            as unsafe extern "C" fn(
                *mut GSettingsBackend,
                *const gchar,
                *mut GVariant,
    ...
    (*backend_class).write_tree = Some(
        safe_c2rust_g_null_settings_backend_write_tree
    ...
    (*backend_class).reset = Some(
        safe_c2rust_g_null_settings_backend_reset
    ...
    (*backend_class).get_writable = Some(
        safe_c2rust_g_null_settings_backend_get_writable
    ...
    (*backend_class).get_permission = Some(
        safe_c2rust_g_null_settings_backend_get_permission
...
#[no_mangle]
pub unsafe extern "C" fn safe_c2rust_g_null_settings_backend_new() -> *mut GSettingsBackend {
    return g_object_new(
        safe_c2rust_g_null_settings_backend_get_type(),
        ::core::ptr::null::<gchar>(),
