extern "C" {
    ...
    fn g_tls_authentication_mode_get_type() -> GType;
    fn g_tls_backend_get_default() -> *mut GTlsBackend;
    fn g_tls_backend_get_dtls_server_connection_type(backend: *mut GTlsBackend) -> GType;
}
...
pub const G_TLS_AUTHENTICATION_REQUIRED: C2RustUnnamed = 2;
pub const G_TLS_AUTHENTICATION_REQUESTED: C2RustUnnamed = 1;
pub const G_TLS_AUTHENTICATION_NONE: C2RustUnnamed = 0;
...
#[no_mangle]
pub unsafe extern "C" fn safe_c2rust_g_dtls_server_connection_get_type() -> GType {
    ...
    }) != 0
    {
        let mut g_define_type_id: GType = g_type_register_static_simple(
            G_TYPE_INTERFACE,
            g_intern_static_string(b"GDtlsServerConnection\0" as *const u8 as *const gchar),
            ::core::mem::size_of::<GDtlsServerConnectionInterface>() as guint,
            ::core::mem::transmute::<Option<unsafe extern "C" fn() -> ()>, GClassInitFunc>(
                ::core::mem::transmute::<
                    Option<unsafe extern "C" fn(*mut GDtlsServerConnectionInterface) -> ()>,
                    Option<unsafe extern "C" fn() -> ()>,
                >(Some(
                    safe_c2rust_g_dtls_server_connection_default_init
                        as unsafe extern "C" fn(*mut GDtlsServerConnectionInterface) -> (),
                )),
            ),
            0 as guint,
...
unsafe extern "C" fn safe_c2rust_g_dtls_server_connection_default_init(
    mut iface: *mut GDtlsServerConnectionInterface,
) {
    g_object_interface_install_property(
        ...
        g_param_spec_enum(
            ...
            G_TLS_AUTHENTICATION_NONE as ::core::ffi::c_int as gint,
...
#[no_mangle]
pub unsafe extern "C" fn safe_c2rust_g_dtls_server_connection_new(
    ...
    conn = g_initable_new(
        ...
        base_socket,
        b"certificate\0" as *const u8 as *const ::core::ffi::c_char,
        certificate,
        NULL,
    ) as *mut GObject;
