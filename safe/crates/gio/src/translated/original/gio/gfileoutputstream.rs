extern "C" {
    ...
    fn g_output_stream_set_pending(stream: *mut GOutputStream, error: *mut *mut GError)
        -> gboolean;
    fn g_output_stream_clear_pending(stream: *mut GOutputStream);
...
#[no_mangle]
pub unsafe extern "C" fn safe_c2rust_g_file_output_stream_get_type() -> GType {
    ...
    {
        let mut g_define_type_id: GType = safe_c2rust_g_file_output_stream_get_type_once();
        if 0 as ::core::ffi::c_int != 0 {
...
#[inline(never)]
unsafe extern "C" fn safe_c2rust_g_file_output_stream_get_type_once() -> GType {
    let mut g_define_type_id: GType = g_type_register_static_simple(
        g_output_stream_get_type(),
        g_intern_static_string(b"GFileOutputStream\0" as *const u8 as *const gchar),
        ::core::mem::size_of::<GFileOutputStreamClass>() as guint,
        ::core::mem::transmute::<Option<unsafe extern "C" fn() -> ()>, GClassInitFunc>(
            ::core::mem::transmute::<
                Option<unsafe extern "C" fn(gpointer) -> ()>,
                Option<unsafe extern "C" fn() -> ()>,
            >(Some(
                safe_c2rust_g_file_output_stream_class_intern_init
                    as unsafe extern "C" fn(gpointer) -> (),
            )),
        ),
        ::core::mem::size_of::<GFileOutputStream>() as guint,
        ::core::mem::transmute::<Option<unsafe extern "C" fn() -> ()>, GInstanceInitFunc>(
            ::core::mem::transmute::<
                Option<unsafe extern "C" fn(*mut GFileOutputStream) -> ()>,
                Option<unsafe extern "C" fn() -> ()>,
            >(Some(
                safe_c2rust_g_file_output_stream_init
                    as unsafe extern "C" fn(*mut GFileOutputStream) -> (),
            )),
        ),
        G_TYPE_FLAG_NONE,
    );
    safe_c2rust_GFileOutputStream_private_offset = g_type_add_instance_private(
        g_define_type_id,
        ::core::mem::size_of::<GFileOutputStreamPrivate>() as gsize,
    );
    let g_implement_interface_info: GInterfaceInfo = _GInterfaceInfo {
        ...
        >(::core::mem::transmute::<
            ...
            Option<unsafe extern "C" fn() -> ()>,
        >(Some(
            safe_c2rust_g_file_output_stream_seekable_iface_init
...
#[inline]
unsafe extern "C" fn safe_c2rust_g_file_output_stream_get_instance_private(
    mut self_0: *mut GFileOutputStream,
) -> gpointer {
    return (self_0 as *mut guint8)
        .offset(safe_c2rust_GFileOutputStream_private_offset as glong as isize)
        as gpointer;
}
static mut safe_c2rust_GFileOutputStream_private_offset: gint = 0;
unsafe extern "C" fn safe_c2rust_g_file_output_stream_class_intern_init(mut klass: gpointer) {
    safe_c2rust_g_file_output_stream_parent_class = g_type_class_peek_parent(klass);
    if safe_c2rust_GFileOutputStream_private_offset != 0 as ::core::ffi::c_int {
        g_type_class_adjust_private_offset(
            klass,
            &raw mut safe_c2rust_GFileOutputStream_private_offset,
        );
    }
    safe_c2rust_g_file_output_stream_class_init(klass as *mut GFileOutputStreamClass);
}
static mut safe_c2rust_g_file_output_stream_parent_class: gpointer = NULL_0;
unsafe extern "C" fn safe_c2rust_g_file_output_stream_class_init(
    mut klass: *mut GFileOutputStreamClass,
) {
    (*klass).query_info_async = Some(
        safe_c2rust_g_file_output_stream_real_query_info_async
    ...
    (*klass).query_info_finish = Some(
        safe_c2rust_g_file_output_stream_real_query_info_finish
            as unsafe extern "C" fn(
                *mut GFileOutputStream,
                *mut GAsyncResult,
                *mut *mut GError,
...
unsafe extern "C" fn safe_c2rust_g_file_output_stream_seekable_iface_init(
    ...
    (*iface).can_truncate = Some(
        safe_c2rust_g_file_output_stream_seekable_can_truncate
            as unsafe extern "C" fn(*mut GSeekable) -> gboolean,
    ) as Option<unsafe extern "C" fn(*mut GSeekable) -> gboolean>;
    (*iface).truncate_fn = Some(
        safe_c2rust_g_file_output_stream_seekable_truncate
            as unsafe extern "C" fn(
                *mut GSeekable,
                goffset,
                *mut GCancellable,
...
unsafe extern "C" fn safe_c2rust_g_file_output_stream_init(mut stream: *mut GFileOutputStream) {
    (*stream).priv_0 = safe_c2rust_g_file_output_stream_get_instance_private(stream)
        as *mut GFileOutputStreamPrivate;
}
#[no_mangle]
pub unsafe extern "C" fn safe_c2rust_g_file_output_stream_query_info(
    mut stream: *mut GFileOutputStream,
    mut attributes: *const ::core::ffi::c_char,
    mut cancellable: *mut GCancellable,
    mut error: *mut *mut GError,
) -> *mut GFileInfo {
    let mut class: *mut GFileOutputStreamClass = ::core::ptr::null_mut::<GFileOutputStreamClass>();
    let mut output_stream: *mut GOutputStream = ::core::ptr::null_mut::<GOutputStream>();
    ...
    if ({
        ...
        if ({
            ...
            let mut __t: GType = safe_c2rust_g_file_output_stream_get_type();
        ...
        != 0
    {
        ...
        g_return_if_fail_warning(
            G_LOG_DOMAIN.as_ptr(),
            G_STRFUNC,
            b"G_IS_FILE_OUTPUT_STREAM (stream)\0" as *const u8 as *const ::core::ffi::c_char,
        );
        return ::core::ptr::null_mut::<GFileInfo>();
    }
    output_stream = stream as *mut ::core::ffi::c_void as *mut GOutputStream;
    if g_output_stream_set_pending(output_stream, error) == 0 {
        return ::core::ptr::null_mut::<GFileInfo>();
    }
    ...
    class = (*(stream as *mut GTypeInstance)).g_class as *mut GFileOutputStreamClass;
...
unsafe extern "C" fn safe_c2rust_async_ready_callback_wrapper(
    ...
    let mut stream: *mut GFileOutputStream =
        source_object as *mut ::core::ffi::c_void as *mut GFileOutputStream;
    g_output_stream_clear_pending(stream as *mut ::core::ffi::c_void as *mut GOutputStream);
...
#[no_mangle]
pub unsafe extern "C" fn safe_c2rust_g_file_output_stream_query_info_async(
    mut stream: *mut GFileOutputStream,
    mut attributes: *const ::core::ffi::c_char,
    ...
    let mut klass: *mut GFileOutputStreamClass = ::core::ptr::null_mut::<GFileOutputStreamClass>();
    let mut output_stream: *mut GOutputStream = ::core::ptr::null_mut::<GOutputStream>();
    ...
    output_stream = stream as *mut ::core::ffi::c_void as *mut GOutputStream;
    if g_output_stream_set_pending(output_stream, &raw mut error) == 0 {
        g_task_report_error(
            stream as gpointer,
            callback,
            user_data,
            ::core::mem::transmute::<
                ...
                gpointer,
            >(Some(
                safe_c2rust_g_file_output_stream_query_info_async
                    as unsafe extern "C" fn(
                        *mut GFileOutputStream,
                        *const ::core::ffi::c_char,
                        ::core::ffi::c_int,
    ...
    klass = (*(stream as *mut GTypeInstance)).g_class as *mut GFileOutputStreamClass;
...
#[no_mangle]
pub unsafe extern "C" fn safe_c2rust_g_file_output_stream_query_info_finish(
    mut stream: *mut GFileOutputStream,
...
#[no_mangle]
pub unsafe extern "C" fn safe_c2rust_g_file_output_stream_get_etag(
    mut stream: *mut GFileOutputStream,
) -> *mut ::core::ffi::c_char {
    let mut class: *mut GFileOutputStreamClass = ::core::ptr::null_mut::<GFileOutputStreamClass>();
    let mut output_stream: *mut GOutputStream = ::core::ptr::null_mut::<GOutputStream>();
    ...
    output_stream = stream as *mut ::core::ffi::c_void as *mut GOutputStream;
    if g_output_stream_is_closed(output_stream) == 0 {
        g_log(
...
unsafe extern "C" fn safe_c2rust_g_file_output_stream_tell(
    mut stream: *mut GFileOutputStream,
) -> goffset {
    let mut class: *mut GFileOutputStreamClass = ::core::ptr::null_mut::<GFileOutputStreamClass>();
...
unsafe extern "C" fn safe_c2rust_g_file_output_stream_seekable_tell(
    mut seekable: *mut GSeekable,
) -> goffset {
    return safe_c2rust_g_file_output_stream_tell(
        seekable as *mut ::core::ffi::c_void as *mut GFileOutputStream,
    );
}
unsafe extern "C" fn safe_c2rust_g_file_output_stream_can_seek(
    mut stream: *mut GFileOutputStream,
) -> gboolean {
    let mut class: *mut GFileOutputStreamClass = ::core::ptr::null_mut::<GFileOutputStreamClass>();
...
unsafe extern "C" fn safe_c2rust_g_file_output_stream_seekable_can_seek(
    mut seekable: *mut GSeekable,
) -> gboolean {
    return safe_c2rust_g_file_output_stream_can_seek(
        seekable as *mut ::core::ffi::c_void as *mut GFileOutputStream,
    );
}
unsafe extern "C" fn safe_c2rust_g_file_output_stream_seek(
    mut stream: *mut GFileOutputStream,
    mut offset: goffset,
...
unsafe extern "C" fn safe_c2rust_g_file_output_stream_seekable_seek(
    mut seekable: *mut GSeekable,
    mut offset: goffset,
    mut type_0: GSeekType,
    mut cancellable: *mut GCancellable,
    ...
    return safe_c2rust_g_file_output_stream_seek(
        seekable as *mut ::core::ffi::c_void as *mut GFileOutputStream,
        offset,
        type_0,
        cancellable,
...
unsafe extern "C" fn safe_c2rust_g_file_output_stream_can_truncate(
    mut stream: *mut GFileOutputStream,
) -> gboolean {
    let mut class: *mut GFileOutputStreamClass = ::core::ptr::null_mut::<GFileOutputStreamClass>();
...
unsafe extern "C" fn safe_c2rust_g_file_output_stream_seekable_can_truncate(
    mut seekable: *mut GSeekable,
) -> gboolean {
    return safe_c2rust_g_file_output_stream_can_truncate(
        seekable as *mut ::core::ffi::c_void as *mut GFileOutputStream,
    );
}
unsafe extern "C" fn safe_c2rust_g_file_output_stream_truncate(
    mut stream: *mut GFileOutputStream,
    mut size: goffset,
    mut cancellable: *mut GCancellable,
    mut error: *mut *mut GError,
...
unsafe extern "C" fn safe_c2rust_g_file_output_stream_seekable_truncate(
    mut seekable: *mut GSeekable,
    mut size: goffset,
    mut cancellable: *mut GCancellable,
    mut error: *mut *mut GError,
) -> gboolean {
    return safe_c2rust_g_file_output_stream_truncate(
        seekable as *mut ::core::ffi::c_void as *mut GFileOutputStream,
        size,
        cancellable,
        error,
...
unsafe extern "C" fn safe_c2rust_query_info_async_thread(
    ...
    let mut stream: *mut GFileOutputStream = source_object as *mut GFileOutputStream;
...
unsafe extern "C" fn safe_c2rust_g_file_output_stream_real_query_info_async(
    mut stream: *mut GFileOutputStream,
    mut attributes: *const ::core::ffi::c_char,
    mut io_priority: ::core::ffi::c_int,
    mut cancellable: *mut GCancellable,
    ...
    if g_task_get_name(_task).is_null() {
        g_task_set_static_name(
            _task,
            b"g_file_output_stream_real_query_info_async\0" as *const u8 as *const gchar,
        );
    }
...
unsafe extern "C" fn safe_c2rust_g_file_output_stream_real_query_info_finish(
    mut stream: *mut GFileOutputStream,
    mut res: *mut GAsyncResult,
    mut error: *mut *mut GError,
) -> *mut GFileInfo {
