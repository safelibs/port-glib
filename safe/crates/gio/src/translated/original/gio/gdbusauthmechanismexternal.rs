extern "C" {
    ...
    fn _g_dbus_auth_mechanism_get_credentials(
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct _GDBusAuthMechanismExternal {
    pub parent_instance: GDBusAuthMechanism,
    pub priv_0: *mut GDBusAuthMechanismExternalPrivate,
}
pub type GDBusAuthMechanismExternalPrivate = _GDBusAuthMechanismExternalPrivate;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct _GDBusAuthMechanismExternalPrivate {
    pub is_client: gboolean,
    pub is_server: gboolean,
    pub state: GDBusAuthMechanismState,
    pub empty_data_sent: gboolean,
}
pub type GDBusAuthMechanismExternal = _GDBusAuthMechanismExternal;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct _GDBusAuthMechanismExternalClass {
    pub parent_class: GDBusAuthMechanismClass,
}
pub type GDBusAuthMechanismExternalClass = _GDBusAuthMechanismExternalClass;
...
unsafe extern "C" fn safe_c2rust__g_dbus_auth_mechanism_external_class_intern_init(
    mut klass: gpointer,
) {
    safe_c2rust__g_dbus_auth_mechanism_external_parent_class = g_type_class_peek_parent(klass);
    if safe_c2rust_GDBusAuthMechanismExternal_private_offset != 0 as ::core::ffi::c_int {
        g_type_class_adjust_private_offset(
            klass,
            &raw mut safe_c2rust_GDBusAuthMechanismExternal_private_offset,
        );
    }
    safe_c2rust__g_dbus_auth_mechanism_external_class_init(
        klass as *mut GDBusAuthMechanismExternalClass,
    );
}
static mut safe_c2rust__g_dbus_auth_mechanism_external_parent_class: gpointer = NULL_0;
#[no_mangle]
pub unsafe extern "C" fn safe_c2rust__g_dbus_auth_mechanism_external_get_type() -> GType {
    ...
    }) != 0
    {
        let mut g_define_type_id: GType =
            safe_c2rust__g_dbus_auth_mechanism_external_get_type_once();
        if 0 as ::core::ffi::c_int != 0 {
...
static mut safe_c2rust_GDBusAuthMechanismExternal_private_offset: gint = 0;
#[inline(never)]
unsafe extern "C" fn safe_c2rust__g_dbus_auth_mechanism_external_get_type_once() -> GType {
    let mut g_define_type_id: GType = g_type_register_static_simple(
        _g_dbus_auth_mechanism_get_type(),
        g_intern_static_string(b"GDBusAuthMechanismExternal\0" as *const u8 as *const gchar),
        ::core::mem::size_of::<GDBusAuthMechanismExternalClass>() as guint,
        ::core::mem::transmute::<Option<unsafe extern "C" fn() -> ()>, GClassInitFunc>(
            ::core::mem::transmute::<
                Option<unsafe extern "C" fn(gpointer) -> ()>,
                Option<unsafe extern "C" fn() -> ()>,
            >(Some(
                safe_c2rust__g_dbus_auth_mechanism_external_class_intern_init
                    as unsafe extern "C" fn(gpointer) -> (),
            )),
        ),
        ::core::mem::size_of::<GDBusAuthMechanismExternal>() as guint,
        ::core::mem::transmute::<Option<unsafe extern "C" fn() -> ()>, GInstanceInitFunc>(
            ::core::mem::transmute::<
                Option<unsafe extern "C" fn(*mut GDBusAuthMechanismExternal) -> ()>,
                Option<unsafe extern "C" fn() -> ()>,
            >(Some(
                safe_c2rust__g_dbus_auth_mechanism_external_init
                    as unsafe extern "C" fn(*mut GDBusAuthMechanismExternal) -> (),
            )),
        ),
        G_TYPE_FLAG_NONE,
    );
    safe_c2rust_GDBusAuthMechanismExternal_private_offset = g_type_add_instance_private(
        g_define_type_id,
        ::core::mem::size_of::<GDBusAuthMechanismExternalPrivate>() as gsize,
    );
    return g_define_type_id;
}
#[inline]
unsafe extern "C" fn safe_c2rust__g_dbus_auth_mechanism_external_get_instance_private(
    mut self_0: *mut GDBusAuthMechanismExternal,
) -> gpointer {
    return (self_0 as *mut guint8)
        .offset(safe_c2rust_GDBusAuthMechanismExternal_private_offset as glong as isize)
        as gpointer;
}
unsafe extern "C" fn safe_c2rust__g_dbus_auth_mechanism_external_finalize(
    mut object: *mut GObject,
) {
    if (*(safe_c2rust__g_dbus_auth_mechanism_external_parent_class as *mut GObjectClass))
        .finalize
        .is_some()
    {
        (*(safe_c2rust__g_dbus_auth_mechanism_external_parent_class as *mut GObjectClass))
            .finalize
            .expect("non-null function pointer")(object);
    }
}
unsafe extern "C" fn safe_c2rust__g_dbus_auth_mechanism_external_class_init(
    mut klass: *mut GDBusAuthMechanismExternalClass,
) {
    ...
    (*gobject_class).finalize = Some(
        safe_c2rust__g_dbus_auth_mechanism_external_finalize
...
unsafe extern "C" fn safe_c2rust__g_dbus_auth_mechanism_external_init(
    mut mechanism: *mut GDBusAuthMechanismExternal,
) {
    (*mechanism).priv_0 =
        safe_c2rust__g_dbus_auth_mechanism_external_get_instance_private(mechanism)
            as *mut GDBusAuthMechanismExternalPrivate;
}
unsafe extern "C" fn safe_c2rust_mechanism_is_supported(
    ...
    if ({
        ...
        if ({
            ...
            let mut __t: GType = safe_c2rust__g_dbus_auth_mechanism_external_get_type();
        ...
        != 0
    {
        ...
        g_return_if_fail_warning(
            G_LOG_DOMAIN.as_ptr(),
            G_STRFUNC,
            b"G_IS_DBUS_AUTH_MECHANISM_EXTERNAL (mechanism)\0" as *const u8
                as *const ::core::ffi::c_char,
        );
        return 0 as gboolean;
    }
    if !_g_dbus_auth_mechanism_get_credentials(mechanism).is_null() {
        return TRUE;
    } else {
        return FALSE;
    };
...
unsafe extern "C" fn safe_c2rust_mechanism_get_name() -> *const gchar {
    return b"EXTERNAL\0" as *const u8 as *const gchar;
}
...
unsafe extern "C" fn safe_c2rust_mechanism_server_get_state(
    ...
    let mut m: *mut GDBusAuthMechanismExternal =
        mechanism as *mut ::core::ffi::c_void as *mut GDBusAuthMechanismExternal;
    if ({
...
unsafe extern "C" fn safe_c2rust_data_matches_credentials(
    mut data: *const gchar,
    mut data_len: gsize,
    ...
    if !credentials.is_null() {
        ...
        {
            if data.is_null() || data_len == 0 as gsize {
                match_0 = TRUE as gboolean;
            } else {
                alleged_uid = g_ascii_strtoll(data, &raw mut endp, 10 as guint);
                if *endp as ::core::ffi::c_int == '\0' as i32 {
                    if g_credentials_get_unix_user(
                        credentials,
...
unsafe extern "C" fn safe_c2rust_mechanism_server_initiate(
    ...
    if !initial_response.is_null() {
        if safe_c2rust_data_matches_credentials(
            initial_response,
...
unsafe extern "C" fn safe_c2rust_mechanism_server_data_send(
    ...
    if (*(*m).priv_0).empty_data_sent != 0 {
        (*(*m).priv_0).state = G_DBUS_AUTH_MECHANISM_STATE_REJECTED;
        return ::core::ptr::null_mut::<gchar>();
    }
    (*(*m).priv_0).state = G_DBUS_AUTH_MECHANISM_STATE_WAITING_FOR_DATA;
    (*(*m).priv_0).empty_data_sent = TRUE as gboolean;
...
unsafe extern "C" fn safe_c2rust_mechanism_server_get_reject_reason(
    ...
    g_assertion_message_expr(
        G_LOG_DOMAIN.as_ptr(),
        b"/home/yans/safelibs/pipeline/ports/port-glib/original/gio/gdbusauthmechanismexternal.c\0"
...
unsafe extern "C" fn safe_c2rust_mechanism_client_initiate(
    ...
    *out_initial_response_len = 0 as gsize;
    if conn_flags as ::core::ffi::c_uint
        & G_DBUS_CONNECTION_FLAGS_CROSS_NAMESPACE as ::core::ffi::c_int as ::core::ffi::c_uint
        != 0
    {
        g_log(
            G_LOG_DOMAIN.as_ptr() as *const gchar,
            G_LOG_LEVEL_DEBUG,
            b"Using cross-namespace EXTERNAL authentication (this will deadlock if server is GDBus < 2.73.3)\0"
            ...
            != 0
        {
            ...
            g_assertion_message_expr(
                ...
                G_STRFUNC,
                b"credentials != NULL\0" as *const u8 as *const ::core::ffi::c_char,
            );
        }
        initial_response = g_strdup_printf(
            b"%li\0" as *const u8 as *const gchar,
            g_credentials_get_unix_user(credentials, ::core::ptr::null_mut::<*mut GError>())
                as gint64,
        );
    }
    if !initial_response.is_null() {
