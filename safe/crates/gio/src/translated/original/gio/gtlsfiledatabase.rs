extern "C" {
    ...
    fn g_tls_backend_get_file_database_type(backend: *mut GTlsBackend) -> GType;
...
#[no_mangle]
pub unsafe extern "C" fn safe_c2rust_g_tls_file_database_get_type() -> GType {
    ...
    }) != 0
    {
        let mut g_define_type_id: GType = g_type_register_static_simple(
            G_TYPE_INTERFACE,
            g_intern_static_string(b"GTlsFileDatabase\0" as *const u8 as *const gchar),
            ::core::mem::size_of::<GTlsFileDatabaseInterface>() as guint,
            ::core::mem::transmute::<Option<unsafe extern "C" fn() -> ()>, GClassInitFunc>(
                ::core::mem::transmute::<
                    Option<unsafe extern "C" fn(*mut GTlsFileDatabaseInterface) -> ()>,
                    Option<unsafe extern "C" fn() -> ()>,
                >(Some(
                    safe_c2rust_g_tls_file_database_default_init
        ...
        if g_tls_database_get_type() != G_TYPE_INVALID {
            g_type_interface_add_prerequisite(g_define_type_id, g_tls_database_get_type());
        }
        if 0 as ::core::ffi::c_int != 0 {
...
unsafe extern "C" fn safe_c2rust_g_tls_file_database_default_init(
...
#[no_mangle]
pub unsafe extern "C" fn safe_c2rust_g_tls_file_database_new(
    mut anchors: *const gchar,
    mut error: *mut *mut GError,
) -> *mut GTlsDatabase {
    let mut database: *mut GObject = ::core::ptr::null_mut::<GObject>();
    let mut backend: *mut GTlsBackend = ::core::ptr::null_mut::<GTlsBackend>();
    backend = g_tls_backend_get_default();
    database = g_initable_new(
    ...
    return database as *mut ::core::ffi::c_void as *mut GTlsDatabase;
}
