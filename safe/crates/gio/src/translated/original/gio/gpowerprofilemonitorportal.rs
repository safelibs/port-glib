...
pub type GPowerProfileMonitorPortal = _GPowerProfileMonitorPortal;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct _GPowerProfileMonitorPortal {
    pub parent_instance: GObject,
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct GPowerProfileMonitorPortalClass {
    pub parent_class: GObjectClass,
}
pub const PROP_POWER_SAVER_ENABLED: GPowerProfileMonitorPortalProperty = 1;
pub type GPowerProfileMonitorPortalProperty = ::core::ffi::c_uint;
...
#[inline]
unsafe extern "C" fn safe_c2rust_G_POWER_PROFILE_MONITOR_PORTAL(
    mut ptr: gpointer,
) -> *mut GPowerProfileMonitorPortal {
    return ptr as *mut GPowerProfileMonitorPortal;
}
static mut safe_c2rust_GPowerProfileMonitorPortal_private_offset: gint = 0;
static mut safe_c2rust_g_power_profile_monitor_portal_parent_class: gpointer = NULL_0;
unsafe extern "C" fn safe_c2rust_g_power_profile_monitor_portal_class_intern_init(
    mut klass: gpointer,
) {
    safe_c2rust_g_power_profile_monitor_portal_parent_class = g_type_class_peek_parent(klass);
    if safe_c2rust_GPowerProfileMonitorPortal_private_offset != 0 as ::core::ffi::c_int {
        g_type_class_adjust_private_offset(
            klass,
            &raw mut safe_c2rust_GPowerProfileMonitorPortal_private_offset,
        );
    }
    safe_c2rust_g_power_profile_monitor_portal_class_init(
        klass as *mut GPowerProfileMonitorPortalClass,
    );
}
#[inline(never)]
unsafe extern "C" fn safe_c2rust_g_power_profile_monitor_portal_get_type_once() -> GType {
    let mut g_define_type_id: GType = g_type_register_static_simple(
        ((20 as ::core::ffi::c_int) << 2 as ::core::ffi::c_int) as GType,
        g_intern_static_string(b"GPowerProfileMonitorPortal\0" as *const u8 as *const gchar),
        ::core::mem::size_of::<GPowerProfileMonitorPortalClass>() as guint,
        ::core::mem::transmute::<Option<unsafe extern "C" fn() -> ()>, GClassInitFunc>(
            ::core::mem::transmute::<
                Option<unsafe extern "C" fn(gpointer) -> ()>,
                Option<unsafe extern "C" fn() -> ()>,
            >(Some(
                safe_c2rust_g_power_profile_monitor_portal_class_intern_init
                    as unsafe extern "C" fn(gpointer) -> (),
            )),
        ),
        ::core::mem::size_of::<GPowerProfileMonitorPortal>() as guint,
        ::core::mem::transmute::<Option<unsafe extern "C" fn() -> ()>, GInstanceInitFunc>(
            ::core::mem::transmute::<
                Option<unsafe extern "C" fn(*mut GPowerProfileMonitorPortal) -> ()>,
                Option<unsafe extern "C" fn() -> ()>,
            >(Some(
                safe_c2rust_g_power_profile_monitor_portal_init
                    as unsafe extern "C" fn(*mut GPowerProfileMonitorPortal) -> (),
            )),
        ),
        G_TYPE_FLAG_NONE,
    );
    let g_implement_interface_info: GInterfaceInfo = _GInterfaceInfo {
        ...
        >(::core::mem::transmute::<
            ...
            Option<unsafe extern "C" fn() -> ()>,
        >(Some(
            safe_c2rust_g_power_profile_monitor_portal_initable_iface_init
    ...
    let g_implement_interface_info_0: GInterfaceInfo = _GInterfaceInfo {
        ...
        >(::core::mem::transmute::<
            ...
            Option<unsafe extern "C" fn() -> ()>,
        >(Some(
            safe_c2rust_g_power_profile_monitor_portal_iface_init
...
#[no_mangle]
pub unsafe extern "C" fn safe_c2rust_g_power_profile_monitor_portal_get_type() -> GType {
    ...
    }) != 0
    {
        let mut g_define_type_id: GType =
            safe_c2rust_g_power_profile_monitor_portal_get_type_once();
        if 0 as ::core::ffi::c_int != 0 {
...
unsafe extern "C" fn safe_c2rust_g_power_profile_monitor_portal_init(
    mut portal: *mut GPowerProfileMonitorPortal,
) {
}
unsafe extern "C" fn safe_c2rust_proxy_properties_changed(
    ...
    g_object_notify(
        ppm as *mut ::core::ffi::c_void as *mut GObject,
        b"power-saver-enabled\0" as *const u8 as *const gchar,
    );
}
unsafe extern "C" fn safe_c2rust_g_power_profile_monitor_portal_get_property(
    mut object: *mut GObject,
    mut prop_id: guint,
    mut value: *mut GValue,
    mut pspec: *mut GParamSpec,
) {
    let mut ppm: *mut GPowerProfileMonitorPortal =
        safe_c2rust_G_POWER_PROFILE_MONITOR_PORTAL(object as gpointer);
    match prop_id as GPowerProfileMonitorPortalProperty as ::core::ffi::c_uint {
        1 => {
        ...
        _ => {
            ...
            g_log(
                ...
                b"%s:%d: invalid %s id %u for \"%s\" of type '%s' in '%s'\0" as *const u8
                    as *const gchar,
                b"/home/yans/safelibs/pipeline/ports/port-glib/original/gio/gpowerprofilemonitorportal.c\0"
...
unsafe extern "C" fn safe_c2rust_g_power_profile_monitor_portal_initable_init(
    mut initable: *mut GInitable,
    mut cancellable: *mut GCancellable,
    mut error: *mut *mut GError,
) -> gboolean {
    let mut ppm: *mut GPowerProfileMonitorPortal =
        safe_c2rust_G_POWER_PROFILE_MONITOR_PORTAL(initable as gpointer);
    let mut proxy: *mut GDBusProxy = ::core::ptr::null_mut::<GDBusProxy>();
    let mut name_owner: *mut gchar = ::core::ptr::null_mut::<gchar>();
    let mut power_saver_enabled_v: *mut GVariant = ::core::ptr::null_mut::<GVariant>();
    ...
    proxy = g_dbus_proxy_new_for_bus_sync(
        ...
        b"/org/freedesktop/portal/desktop\0" as *const u8 as *const gchar,
        b"org.freedesktop.portal.PowerProfileMonitor\0" as *const u8 as *const gchar,
        cancellable,
        error,
    );
    if proxy.is_null() {
    ...
    (*ppm).signal_id = g_signal_connect_data(
        proxy as gpointer,
        b"g-properties-changed\0" as *const u8 as *const gchar,
        ::core::mem::transmute::<
            Option<unsafe extern "C" fn(*mut GDBusProxy, *mut GVariant, GStrv, gpointer) -> ()>,
            GCallback,
        >(Some(
            safe_c2rust_proxy_properties_changed
                as unsafe extern "C" fn(*mut GDBusProxy, *mut GVariant, GStrv, gpointer) -> (),
        )),
        ppm as gpointer,
        None,
        G_CONNECT_DEFAULT,
    );
    power_saver_enabled_v = g_dbus_proxy_get_cached_property(
        proxy,
        b"power-saver-enabled\0" as *const u8 as *const gchar,
    );
    if !power_saver_enabled_v.is_null()
        && g_variant_is_of_type(power_saver_enabled_v, G_VARIANT_TYPE_BOOLEAN) != 0
    {
        (*ppm).power_saver_enabled = g_variant_get_boolean(power_saver_enabled_v);
    }
    let mut _pp: *mut *mut GVariant = &raw mut power_saver_enabled_v;
    let mut _ptr: *mut GVariant = *_pp;
    *_pp = ::core::ptr::null_mut::<GVariant>();
    if !_ptr.is_null() {
        g_variant_unref(_ptr as *mut GVariant);
    }
    (*ppm).proxy = safe_c2rust_g_steal_pointer(&raw mut proxy as gpointer) as *mut GDBusProxy
        as *mut GDBusProxy;
    return TRUE;
}
unsafe extern "C" fn safe_c2rust_g_power_profile_monitor_portal_finalize(mut object: *mut GObject) {
    let mut ppm: *mut GPowerProfileMonitorPortal =
        safe_c2rust_G_POWER_PROFILE_MONITOR_PORTAL(object as gpointer);
    let _instance: gpointer = (*ppm).proxy as gpointer;
    let _handler_id_ptr: *mut gulong = &raw mut (*ppm).signal_id;
    ...
    let mut _pp: *mut *mut GDBusProxy = &raw mut (*ppm).proxy;
    let mut _ptr: *mut GDBusProxy = *_pp;
    *_pp = ::core::ptr::null_mut::<GDBusProxy>();
    if !_ptr.is_null() {
        g_object_unref(_ptr as gpointer);
    }
    (*(safe_c2rust_g_power_profile_monitor_portal_parent_class as *mut GObjectClass))
        .finalize
        .expect("non-null function pointer")(object);
}
unsafe extern "C" fn safe_c2rust_g_power_profile_monitor_portal_class_init(
    mut nl_class: *mut GPowerProfileMonitorPortalClass,
) {
    let mut gobject_class: *mut GObjectClass =
        nl_class as *mut ::core::ffi::c_void as *mut GObjectClass;
    (*gobject_class).get_property = Some(
        safe_c2rust_g_power_profile_monitor_portal_get_property
            as unsafe extern "C" fn(*mut GObject, guint, *mut GValue, *mut GParamSpec) -> (),
    )
        as Option<unsafe extern "C" fn(*mut GObject, guint, *mut GValue, *mut GParamSpec) -> ()>;
    (*gobject_class).finalize = Some(
        safe_c2rust_g_power_profile_monitor_portal_finalize
...
unsafe extern "C" fn safe_c2rust_g_power_profile_monitor_portal_iface_init(
    mut monitor_iface: *mut GPowerProfileMonitorInterface,
) {
}
unsafe extern "C" fn safe_c2rust_g_power_profile_monitor_portal_initable_iface_init(
    mut iface: *mut GInitableIface,
) {
    (*iface).init = Some(
        safe_c2rust_g_power_profile_monitor_portal_initable_init
