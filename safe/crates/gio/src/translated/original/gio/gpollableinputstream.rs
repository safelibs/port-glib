...
#[no_mangle]
pub unsafe extern "C" fn safe_c2rust_g_pollable_input_stream_get_type() -> GType {
    ...
    }) != 0
    {
        let mut g_define_type_id: GType = g_type_register_static_simple(
            G_TYPE_INTERFACE,
            g_intern_static_string(b"GPollableInputStream\0" as *const u8 as *const gchar),
            ::core::mem::size_of::<GPollableInputStreamInterface>() as guint,
            ::core::mem::transmute::<Option<unsafe extern "C" fn() -> ()>, GClassInitFunc>(
                ::core::mem::transmute::<
                    Option<unsafe extern "C" fn(*mut GPollableInputStreamInterface) -> ()>,
                    Option<unsafe extern "C" fn() -> ()>,
                >(Some(
                    safe_c2rust_g_pollable_input_stream_default_init
        ...
        if g_input_stream_get_type() != G_TYPE_INVALID {
            g_type_interface_add_prerequisite(g_define_type_id, g_input_stream_get_type());
        }
        if 0 as ::core::ffi::c_int != 0 {
...
unsafe extern "C" fn safe_c2rust_g_pollable_input_stream_default_init(
    mut iface: *mut GPollableInputStreamInterface,
) {
    (*iface).can_poll = Some(
        safe_c2rust_g_pollable_input_stream_default_can_poll
    ...
    (*iface).read_nonblocking = Some(
        safe_c2rust_g_pollable_input_stream_default_read_nonblocking
...
unsafe extern "C" fn safe_c2rust_g_pollable_input_stream_default_can_poll(
    mut stream: *mut GPollableInputStream,
) -> gboolean {
    return TRUE;
}
#[no_mangle]
pub unsafe extern "C" fn safe_c2rust_g_pollable_input_stream_can_poll(
    mut stream: *mut GPollableInputStream,
) -> gboolean {
    if ({
        ...
        if ({
            ...
            let mut __t: GType = safe_c2rust_g_pollable_input_stream_get_type();
        ...
        != 0
    {
        ...
        g_return_if_fail_warning(
            G_LOG_DOMAIN.as_ptr(),
            G_STRFUNC,
            b"G_IS_POLLABLE_INPUT_STREAM (stream)\0" as *const u8 as *const ::core::ffi::c_char,
        );
        return 0 as gboolean;
    }
    return (*(g_type_interface_peek(
        (*(stream as *mut GTypeInstance)).g_class as gpointer,
        safe_c2rust_g_pollable_input_stream_get_type(),
    ) as *mut GPollableInputStreamInterface))
        .can_poll
        .expect("non-null function pointer")(stream);
}
#[no_mangle]
pub unsafe extern "C" fn safe_c2rust_g_pollable_input_stream_is_readable(
    mut stream: *mut GPollableInputStream,
) -> gboolean {
    if ({
...
#[no_mangle]
pub unsafe extern "C" fn safe_c2rust_g_pollable_input_stream_create_source(
    mut stream: *mut GPollableInputStream,
...
unsafe extern "C" fn safe_c2rust_g_pollable_input_stream_default_read_nonblocking(
    mut stream: *mut GPollableInputStream,
    mut buffer: *mut ::core::ffi::c_void,
    mut count: gsize,
    mut error: *mut *mut GError,
) -> gssize {
    if safe_c2rust_g_pollable_input_stream_is_readable(stream) == 0 {
        g_set_error_literal(
            error,
            g_io_error_quark(),
    ...
    return (*((*(stream as *mut GTypeInstance)).g_class as *mut GInputStreamClass))
        .read_fn
...
#[no_mangle]
pub unsafe extern "C" fn safe_c2rust_g_pollable_input_stream_read_nonblocking(
    mut stream: *mut GPollableInputStream,
    mut buffer: *mut ::core::ffi::c_void,
    mut count: gsize,
    mut cancellable: *mut GCancellable,
