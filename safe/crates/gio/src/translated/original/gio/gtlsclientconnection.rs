extern "C" {
    ...
    fn g_tls_backend_get_client_connection_type(backend: *mut GTlsBackend) -> GType;
}
...
#[no_mangle]
pub unsafe extern "C" fn safe_c2rust_g_tls_client_connection_get_type() -> GType {
    ...
    }) != 0
    {
        let mut g_define_type_id: GType = g_type_register_static_simple(
            G_TYPE_INTERFACE,
            g_intern_static_string(b"GTlsClientConnection\0" as *const u8 as *const gchar),
            ::core::mem::size_of::<GTlsClientConnectionInterface>() as guint,
            ::core::mem::transmute::<Option<unsafe extern "C" fn() -> ()>, GClassInitFunc>(
                ::core::mem::transmute::<
                    Option<unsafe extern "C" fn(*mut GTlsClientConnectionInterface) -> ()>,
                    Option<unsafe extern "C" fn() -> ()>,
                >(Some(
                    safe_c2rust_g_tls_client_connection_default_init
                        as unsafe extern "C" fn(*mut GTlsClientConnectionInterface) -> (),
                )),
            ),
            0 as guint,
        ...
        if g_tls_connection_get_type() != G_TYPE_INVALID {
            g_type_interface_add_prerequisite(g_define_type_id, g_tls_connection_get_type());
        }
        if 0 as ::core::ffi::c_int != 0 {
...
unsafe extern "C" fn safe_c2rust_g_tls_client_connection_default_init(
    mut iface: *mut GTlsClientConnectionInterface,
) {
...
#[no_mangle]
pub unsafe extern "C" fn safe_c2rust_g_tls_client_connection_new(
    ...
    return conn as *mut ::core::ffi::c_void as *mut GIOStream;
}
#[no_mangle]
pub unsafe extern "C" fn safe_c2rust_g_tls_client_connection_get_validation_flags(
    mut conn: *mut GTlsClientConnection,
    ...
    if ({
        ...
        if ({
            ...
            let mut __t: GType = safe_c2rust_g_tls_client_connection_get_type();
        ...
        != 0
    {
        ...
        g_return_if_fail_warning(
            G_LOG_DOMAIN.as_ptr(),
            G_STRFUNC,
            b"G_IS_TLS_CLIENT_CONNECTION (conn)\0" as *const u8 as *const ::core::ffi::c_char,
        );
...
#[no_mangle]
pub unsafe extern "C" fn safe_c2rust_g_tls_client_connection_set_validation_flags(
    mut conn: *mut GTlsClientConnection,
...
#[no_mangle]
pub unsafe extern "C" fn safe_c2rust_g_tls_client_connection_get_server_identity(
    mut conn: *mut GTlsClientConnection,
...
#[no_mangle]
pub unsafe extern "C" fn safe_c2rust_g_tls_client_connection_set_server_identity(
    mut conn: *mut GTlsClientConnection,
...
#[no_mangle]
pub unsafe extern "C" fn safe_c2rust_g_tls_client_connection_get_use_ssl3(
    mut conn: *mut GTlsClientConnection,
) -> gboolean {
    let mut use_ssl3: gboolean = FALSE;
    if ({
...
#[no_mangle]
pub unsafe extern "C" fn safe_c2rust_g_tls_client_connection_set_use_ssl3(
    mut conn: *mut GTlsClientConnection,
    mut use_ssl3: gboolean,
) {
    if ({
...
#[no_mangle]
pub unsafe extern "C" fn safe_c2rust_g_tls_client_connection_get_accepted_cas(
    mut conn: *mut GTlsClientConnection,
) -> *mut GList {
...
#[no_mangle]
pub unsafe extern "C" fn safe_c2rust_g_tls_client_connection_copy_session_state(
    mut conn: *mut GTlsClientConnection,
    mut source: *mut GTlsClientConnection,
) {
    if ({
        ...
        != 0
    {
        ...
        g_return_if_fail_warning(
            G_LOG_DOMAIN.as_ptr(),
            G_STRFUNC,
            b"G_IS_TLS_CLIENT_CONNECTION (source)\0" as *const u8 as *const ::core::ffi::c_char,
        );
        return;
    }
    if ({
        ...
        if (*(g_type_interface_peek(
            ...
            safe_c2rust_g_tls_client_connection_get_type(),
        ) as *mut GTlsClientConnectionInterface))
            .copy_session_state
            .is_some()
        {
        ...
        != 0
    {
        ...
        g_return_if_fail_warning(
            G_LOG_DOMAIN.as_ptr(),
            G_STRFUNC,
            b"G_TLS_CLIENT_CONNECTION_GET_INTERFACE (conn)->copy_session_state != NULL\0"
    ...
    (*(g_type_interface_peek(
        ...
        .copy_session_state
        .expect("non-null function pointer")(conn, source);
}
