...
extern "C" {
    ...
    fn g_memory_monitor_warning_level_get_type() -> GType;
...
pub const LOW_MEMORY_WARNING: C2RustUnnamed_0 = 0;
...
#[no_mangle]
pub unsafe extern "C" fn safe_c2rust_g_memory_monitor_get_type() -> GType {
    ...
    }) != 0
    {
        let mut g_define_type_id: GType = g_type_register_static_simple(
            G_TYPE_INTERFACE,
            g_intern_static_string(b"GMemoryMonitor\0" as *const u8 as *const gchar),
            ::core::mem::size_of::<GMemoryMonitorInterface>() as guint,
            ::core::mem::transmute::<Option<unsafe extern "C" fn() -> ()>, GClassInitFunc>(
                ::core::mem::transmute::<
                    Option<unsafe extern "C" fn(*mut GMemoryMonitorInterface) -> ()>,
                    Option<unsafe extern "C" fn() -> ()>,
                >(Some(
                    safe_c2rust_g_memory_monitor_default_init
...
#[no_mangle]
pub unsafe extern "C" fn safe_c2rust_g_memory_monitor_dup_default() -> *mut GMemoryMonitor {
    return g_object_ref(_g_io_module_get_default(
        b"gio-memory-monitor\0" as *const u8 as *const gchar,
        b"GIO_USE_MEMORY_MONITOR\0" as *const u8 as *const gchar,
        None,
    )) as *mut GMemoryMonitor;
}
unsafe extern "C" fn safe_c2rust_g_memory_monitor_default_init(
    mut iface: *mut GMemoryMonitorInterface,
) {
    safe_c2rust_signals[LOW_MEMORY_WARNING as ::core::ffi::c_int as usize] = g_signal_new(
        g_intern_static_string(b"low-memory-warning\0" as *const u8 as *const gchar),
        safe_c2rust_g_memory_monitor_get_type(),
        G_SIGNAL_RUN_LAST,
