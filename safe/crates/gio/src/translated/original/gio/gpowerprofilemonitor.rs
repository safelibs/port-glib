extern "C" {
    pub type _GData;
    pub type _GPowerProfileMonitor;
...
#[no_mangle]
pub unsafe extern "C" fn safe_c2rust_g_power_profile_monitor_get_type() -> GType {
    ...
    }) != 0
    {
        let mut g_define_type_id: GType = g_type_register_static_simple(
            G_TYPE_INTERFACE,
            g_intern_static_string(b"GPowerProfileMonitor\0" as *const u8 as *const gchar),
            ::core::mem::size_of::<GPowerProfileMonitorInterface>() as guint,
            ::core::mem::transmute::<Option<unsafe extern "C" fn() -> ()>, GClassInitFunc>(
                ::core::mem::transmute::<
                    Option<unsafe extern "C" fn(*mut GPowerProfileMonitorInterface) -> ()>,
                    Option<unsafe extern "C" fn() -> ()>,
                >(Some(
                    safe_c2rust_g_power_profile_monitor_default_init
...
#[no_mangle]
pub unsafe extern "C" fn safe_c2rust_g_power_profile_monitor_dup_default(
) -> *mut GPowerProfileMonitor {
    return g_object_ref(_g_io_module_get_default(
        b"gio-power-profile-monitor\0" as *const u8 as *const gchar,
        b"GIO_USE_POWER_PROFILE_MONITOR\0" as *const u8 as *const gchar,
        None,
    )) as *mut GPowerProfileMonitor;
}
#[no_mangle]
pub unsafe extern "C" fn safe_c2rust_g_power_profile_monitor_get_power_saver_enabled(
    mut monitor: *mut GPowerProfileMonitor,
) -> gboolean {
...
unsafe extern "C" fn safe_c2rust_g_power_profile_monitor_default_init(
    mut iface: *mut GPowerProfileMonitorInterface,
) {
