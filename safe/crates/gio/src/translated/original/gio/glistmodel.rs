...
extern "C" {
    ...
    fn _g_cclosure_marshal_VOID__UINT_UINT_UINT(
    ...
    fn _g_cclosure_marshal_VOID__UINT_UINT_UINTv(
        closure: *mut GClosure,
        return_value: *mut GValue,
        instance: gpointer,
...
#[inline]
unsafe extern "C" fn safe_c2rust_G_LIST_MODEL_GET_IFACE(
    mut ptr: gpointer,
) -> *mut GListModelInterface {
    return g_type_interface_peek(
        (*(ptr as *mut GTypeInstance)).g_class as gpointer,
        safe_c2rust_g_list_model_get_type(),
    ) as *mut GListModelInterface;
}
#[inline]
unsafe extern "C" fn safe_c2rust_G_IS_LIST_MODEL(mut ptr: gpointer) -> gboolean {
    return ({
        let mut __inst: *mut GTypeInstance = ptr as *mut GTypeInstance;
        let mut __t: GType = safe_c2rust_g_list_model_get_type();
...
#[no_mangle]
pub unsafe extern "C" fn safe_c2rust_g_list_model_get_type() -> GType {
    ...
    }) != 0
    {
        let mut g_define_type_id: GType = g_type_register_static_simple(
            G_TYPE_INTERFACE,
            g_intern_static_string(b"GListModel\0" as *const u8 as *const gchar),
            ::core::mem::size_of::<GListModelInterface>() as guint,
            ::core::mem::transmute::<Option<unsafe extern "C" fn() -> ()>, GClassInitFunc>(
                ::core::mem::transmute::<
                    Option<unsafe extern "C" fn(*mut GListModelInterface) -> ()>,
                    Option<unsafe extern "C" fn() -> ()>,
                >(Some(
                    safe_c2rust_g_list_model_default_init
...
static mut safe_c2rust_g_list_model_changed_signal: guint = 0;
unsafe extern "C" fn safe_c2rust_g_list_model_default_init(mut iface: *mut GListModelInterface) {
    safe_c2rust_g_list_model_changed_signal = g_signal_new(
    ...
    g_signal_set_va_marshaller(
        safe_c2rust_g_list_model_changed_signal,
...
#[no_mangle]
pub unsafe extern "C" fn safe_c2rust_g_list_model_get_item_type(
    mut list: *mut GListModel,
) -> GType {
    if ({
        let mut _g_boolean_var_10: ::core::ffi::c_int = 0;
        if safe_c2rust_G_IS_LIST_MODEL(list as gpointer) != 0 {
        ...
        != 0
    {
        ...
        g_return_if_fail_warning(
            G_LOG_DOMAIN.as_ptr(),
            G_STRFUNC,
            b"G_IS_LIST_MODEL (list)\0" as *const u8 as *const ::core::ffi::c_char,
        );
        return ((1 as ::core::ffi::c_int) << 2 as ::core::ffi::c_int) as GType;
    }
    return (*safe_c2rust_G_LIST_MODEL_GET_IFACE(list as gpointer))
        .get_item_type
        .expect("non-null function pointer")(list);
}
#[no_mangle]
pub unsafe extern "C" fn safe_c2rust_g_list_model_get_n_items(mut list: *mut GListModel) -> guint {
    if ({
...
#[no_mangle]
pub unsafe extern "C" fn safe_c2rust_g_list_model_get_item(
    mut list: *mut GListModel,
    mut position: guint,
) -> gpointer {
    if ({
    ...
    return (*safe_c2rust_G_LIST_MODEL_GET_IFACE(list as gpointer))
        .get_item
        .expect("non-null function pointer")(list, position);
}
#[no_mangle]
pub unsafe extern "C" fn safe_c2rust_g_list_model_get_object(
    mut list: *mut GListModel,
    mut position: guint,
) -> *mut GObject {
    ...
    item = safe_c2rust_g_list_model_get_item(list, position);
    return item as *mut GObject;
}
#[no_mangle]
pub unsafe extern "C" fn safe_c2rust_g_list_model_items_changed(
    mut list: *mut GListModel,
    mut position: guint,
    mut removed: guint,
    mut added: guint,
