...
unsafe extern "C" {
    ...
    #[link_name = "safe_glib_backend_g_locale_from_utf8"]
    ...
    #[link_name = "safe_glib_backend_g_filename_to_utf8"]
    ...
    #[link_name = "safe_glib_backend_g_filename_from_utf8"]
    ...
    #[link_name = "safe_glib_backend_g_filename_display_name"]
    fn raw_g_filename_display_name(filename: *const gchar) -> *mut gchar;
    #[link_name = "safe_glib_backend_g_filename_display_basename"]
    fn raw_g_filename_display_basename(filename: *const gchar) -> *mut gchar;

    #[link_name = "safe_glib_backend_g_canonicalize_filename"]
    fn raw_g_canonicalize_filename(filename: *const gchar, relative_to: *const gchar) -> *mut gchar;
    ...
    #[link_name = "safe_glib_backend_g_markup_parse_context_new"]
    ...
    #[link_name = "safe_glib_backend_g_markup_parse_context_end_parse"]
    fn raw_g_markup_parse_context_end_parse(
        context: *mut GMarkupParseContext,
        error: *mut *mut GError,
    ) -> gboolean;

    #[link_name = "safe_glib_backend_g_spawn_async"]
    ...
    #[link_name = "safe_glib_backend_g_spawn_async_with_pipes"]
    ...
    #[link_name = "safe_glib_backend_g_spawn_async_with_pipes_and_fds"]
    ...
    #[link_name = "safe_glib_backend_g_spawn_async_with_fds"]
    ...
    #[link_name = "safe_glib_backend_g_spawn_sync"]
    fn raw_g_spawn_sync(
        working_directory: *const gchar,
        argv: *mut *mut gchar,
        envp: *mut *mut gchar,
    ...
    #[link_name = "safe_glib_backend_g_spawn_command_line_sync"]
    ...
    #[link_name = "safe_glib_backend_g_spawn_command_line_async"]
    fn raw_g_spawn_command_line_async(command_line: *const gchar, error: *mut *mut GError) -> gboolean;

    #[link_name = "safe_glib_backend_g_variant_new_from_bytes"]
    fn raw_g_variant_new_from_bytes(
        type_: *const GVariantType,
        bytes: *mut GBytes,
        trusted: gboolean,
    ) -> *mut GVariant;
    #[link_name = "safe_glib_backend_g_variant_new_from_data"]
    ...
    #[link_name = "safe_glib_backend_g_variant_is_normal_form"]
    fn raw_g_variant_is_normal_form(value: *mut GVariant) -> gboolean;
    #[link_name = "safe_glib_backend_g_variant_get_normal_form"]
    fn raw_g_variant_get_normal_form(value: *mut GVariant) -> *mut GVariant;
    #[link_name = "safe_glib_backend_g_variant_byteswap"]
...
pub(crate) unsafe fn canonicalize_filename(
    ...
    raw_g_canonicalize_filename(filename, relative_to)
}
...
pub(crate) unsafe fn key_file_load_from_data(
    ...
    raw_g_key_file_load_from_data(key_file, data, length, flags, error)
}
