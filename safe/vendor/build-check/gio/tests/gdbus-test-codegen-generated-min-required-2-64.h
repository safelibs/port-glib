...
#ifndef __GDBUS_TEST_CODEGEN_GENERATED_MIN_REQUIRED_2_64_H__
#define __GDBUS_TEST_CODEGEN_GENERATED_MIN_REQUIRED_2_64_H__
...
/* ------------------------------------------------------------------------ */
/* Declarations for test.FDPassing */

#define FOO_IGEN_TYPE_TEST_FDPASSING (foo_igen_test_fdpassing_get_type ())
#define FOO_IGEN_TEST_FDPASSING(o) (G_TYPE_CHECK_INSTANCE_CAST ((o), FOO_IGEN_TYPE_TEST_FDPASSING, FooiGenTestFDPassing))
#define FOO_IGEN_IS_TEST_FDPASSING(o) (G_TYPE_CHECK_INSTANCE_TYPE ((o), FOO_IGEN_TYPE_TEST_FDPASSING))
#define FOO_IGEN_TEST_FDPASSING_GET_IFACE(o) (G_TYPE_INSTANCE_GET_INTERFACE ((o), FOO_IGEN_TYPE_TEST_FDPASSING, FooiGenTestFDPassingIface))

struct _FooiGenTestFDPassing;
typedef struct _FooiGenTestFDPassing FooiGenTestFDPassing;
typedef struct _FooiGenTestFDPassingIface FooiGenTestFDPassingIface;

struct _FooiGenTestFDPassingIface
{
  GTypeInterface parent_iface;

  gboolean (*handle_hello_fd) (
    FooiGenTestFDPassing *object,
    GDBusMethodInvocation *invocation,
    GUnixFDList *fd_list,
    const gchar *arg_greeting);
...
#if GLIB_CHECK_VERSION(2, 44, 0)
G_DEFINE_AUTOPTR_CLEANUP_FUNC (FooiGenTestFDPassing, g_object_unref)
#endif

GType foo_igen_test_fdpassing_get_type (void) G_GNUC_CONST;

GDBusInterfaceInfo *foo_igen_test_fdpassing_interface_info (void);
guint foo_igen_test_fdpassing_override_properties (GObjectClass *klass, guint property_id_begin);


/* D-Bus method call completion functions: */
void foo_igen_test_fdpassing_complete_hello_fd (
    FooiGenTestFDPassing *object,
    GDBusMethodInvocation *invocation,
    GUnixFDList *fd_list,
    const gchar *response);

void foo_igen_test_fdpassing_complete_no_annotation (
    FooiGenTestFDPassing *object,
    GDBusMethodInvocation *invocation,
    GUnixFDList *fd_list,
    GVariant *response,
...
void foo_igen_test_fdpassing_complete_no_annotation_nested (
    FooiGenTestFDPassing *object,
    GDBusMethodInvocation *invocation,
    GUnixFDList *fd_list);
...
/* D-Bus method calls: */
void foo_igen_test_fdpassing_call_hello_fd (
    FooiGenTestFDPassing *proxy,
    const gchar *arg_greeting,
    GDBusCallFlags call_flags,
    gint timeout_msec,
    GUnixFDList *fd_list,
...
gboolean foo_igen_test_fdpassing_call_hello_fd_finish (
    FooiGenTestFDPassing *proxy,
    gchar **out_response,
...
gboolean foo_igen_test_fdpassing_call_hello_fd_sync (
    FooiGenTestFDPassing *proxy,
    const gchar *arg_greeting,
    GDBusCallFlags call_flags,
    gint timeout_msec,
...
void foo_igen_test_fdpassing_call_no_annotation (
    FooiGenTestFDPassing *proxy,
    GVariant *arg_greeting,
    const gchar *arg_greeting_locale,
    GDBusCallFlags call_flags,
...
gboolean foo_igen_test_fdpassing_call_no_annotation_finish (
    FooiGenTestFDPassing *proxy,
...
gboolean foo_igen_test_fdpassing_call_no_annotation_sync (
    FooiGenTestFDPassing *proxy,
    GVariant *arg_greeting,
    const gchar *arg_greeting_locale,
    GDBusCallFlags call_flags,
...
void foo_igen_test_fdpassing_call_no_annotation_nested (
    FooiGenTestFDPassing *proxy,
    GVariant *arg_files,
    GDBusCallFlags call_flags,
    gint timeout_msec,
...
gboolean foo_igen_test_fdpassing_call_no_annotation_nested_finish (
    FooiGenTestFDPassing *proxy,
    GUnixFDList **out_fd_list,
    GAsyncResult *res,
    GError **error);

gboolean foo_igen_test_fdpassing_call_no_annotation_nested_sync (
    FooiGenTestFDPassing *proxy,
    GVariant *arg_files,
    GDBusCallFlags call_flags,
    gint timeout_msec,
...
#define FOO_IGEN_TYPE_TEST_FDPASSING_PROXY (foo_igen_test_fdpassing_proxy_get_type ())
#define FOO_IGEN_TEST_FDPASSING_PROXY(o) (G_TYPE_CHECK_INSTANCE_CAST ((o), FOO_IGEN_TYPE_TEST_FDPASSING_PROXY, FooiGenTestFDPassingProxy))
#define FOO_IGEN_TEST_FDPASSING_PROXY_CLASS(k) (G_TYPE_CHECK_CLASS_CAST ((k), FOO_IGEN_TYPE_TEST_FDPASSING_PROXY, FooiGenTestFDPassingProxyClass))
#define FOO_IGEN_TEST_FDPASSING_PROXY_GET_CLASS(o) (G_TYPE_INSTANCE_GET_CLASS ((o), FOO_IGEN_TYPE_TEST_FDPASSING_PROXY, FooiGenTestFDPassingProxyClass))
#define FOO_IGEN_IS_TEST_FDPASSING_PROXY(o) (G_TYPE_CHECK_INSTANCE_TYPE ((o), FOO_IGEN_TYPE_TEST_FDPASSING_PROXY))
#define FOO_IGEN_IS_TEST_FDPASSING_PROXY_CLASS(k) (G_TYPE_CHECK_CLASS_TYPE ((k), FOO_IGEN_TYPE_TEST_FDPASSING_PROXY))

typedef struct _FooiGenTestFDPassingProxy FooiGenTestFDPassingProxy;
typedef struct _FooiGenTestFDPassingProxyClass FooiGenTestFDPassingProxyClass;
typedef struct _FooiGenTestFDPassingProxyPrivate FooiGenTestFDPassingProxyPrivate;

struct _FooiGenTestFDPassingProxy
{
  /*< private >*/
  GDBusProxy parent_instance;
  FooiGenTestFDPassingProxyPrivate *priv;
};

struct _FooiGenTestFDPassingProxyClass
{
  GDBusProxyClass parent_class;
};

GType foo_igen_test_fdpassing_proxy_get_type (void) G_GNUC_CONST;

#if GLIB_CHECK_VERSION(2, 44, 0)
G_DEFINE_AUTOPTR_CLEANUP_FUNC (FooiGenTestFDPassingProxy, g_object_unref)
#endif

void foo_igen_test_fdpassing_proxy_new (
    GDBusConnection     *connection,
    GDBusProxyFlags      flags,
    const gchar         *name,
    const gchar         *object_path,
    ...
    GAsyncReadyCallback  callback,
    gpointer             user_data);
FooiGenTestFDPassing *foo_igen_test_fdpassing_proxy_new_finish (
    GAsyncResult        *res,
    GError             **error);
FooiGenTestFDPassing *foo_igen_test_fdpassing_proxy_new_sync (
    GDBusConnection     *connection,
    GDBusProxyFlags      flags,
    const gchar         *name,
    const gchar         *object_path,
...
void foo_igen_test_fdpassing_proxy_new_for_bus (
    GBusType             bus_type,
    GDBusProxyFlags      flags,
    const gchar         *name,
    const gchar         *object_path,
    ...
    GAsyncReadyCallback  callback,
    gpointer             user_data);
FooiGenTestFDPassing *foo_igen_test_fdpassing_proxy_new_for_bus_finish (
    GAsyncResult        *res,
    GError             **error);
FooiGenTestFDPassing *foo_igen_test_fdpassing_proxy_new_for_bus_sync (
    GBusType             bus_type,
    GDBusProxyFlags      flags,
    const gchar         *name,
    const gchar         *object_path,
...
#define FOO_IGEN_TYPE_TEST_FDPASSING_SKELETON (foo_igen_test_fdpassing_skeleton_get_type ())
#define FOO_IGEN_TEST_FDPASSING_SKELETON(o) (G_TYPE_CHECK_INSTANCE_CAST ((o), FOO_IGEN_TYPE_TEST_FDPASSING_SKELETON, FooiGenTestFDPassingSkeleton))
#define FOO_IGEN_TEST_FDPASSING_SKELETON_CLASS(k) (G_TYPE_CHECK_CLASS_CAST ((k), FOO_IGEN_TYPE_TEST_FDPASSING_SKELETON, FooiGenTestFDPassingSkeletonClass))
#define FOO_IGEN_TEST_FDPASSING_SKELETON_GET_CLASS(o) (G_TYPE_INSTANCE_GET_CLASS ((o), FOO_IGEN_TYPE_TEST_FDPASSING_SKELETON, FooiGenTestFDPassingSkeletonClass))
#define FOO_IGEN_IS_TEST_FDPASSING_SKELETON(o) (G_TYPE_CHECK_INSTANCE_TYPE ((o), FOO_IGEN_TYPE_TEST_FDPASSING_SKELETON))
#define FOO_IGEN_IS_TEST_FDPASSING_SKELETON_CLASS(k) (G_TYPE_CHECK_CLASS_TYPE ((k), FOO_IGEN_TYPE_TEST_FDPASSING_SKELETON))

typedef struct _FooiGenTestFDPassingSkeleton FooiGenTestFDPassingSkeleton;
typedef struct _FooiGenTestFDPassingSkeletonClass FooiGenTestFDPassingSkeletonClass;
typedef struct _FooiGenTestFDPassingSkeletonPrivate FooiGenTestFDPassingSkeletonPrivate;

struct _FooiGenTestFDPassingSkeleton
{
  /*< private >*/
  GDBusInterfaceSkeleton parent_instance;
  FooiGenTestFDPassingSkeletonPrivate *priv;
};

struct _FooiGenTestFDPassingSkeletonClass
{
  GDBusInterfaceSkeletonClass parent_class;
};

GType foo_igen_test_fdpassing_skeleton_get_type (void) G_GNUC_CONST;

#if GLIB_CHECK_VERSION(2, 44, 0)
G_DEFINE_AUTOPTR_CLEANUP_FUNC (FooiGenTestFDPassingSkeleton, g_object_unref)
#endif

FooiGenTestFDPassing *foo_igen_test_fdpassing_skeleton_new (void);
...
FooiGenTestFDPassing *foo_igen_object_get_test_fdpassing (FooiGenObject *object);
...
FooiGenTestFDPassing *foo_igen_object_peek_test_fdpassing (FooiGenObject *object);
...
void foo_igen_object_skeleton_set_test_fdpassing (FooiGenObjectSkeleton *object, FooiGenTestFDPassing *interface_);
...
#endif /* __GDBUS_TEST_CODEGEN_GENERATED_MIN_REQUIRED_2_64_H__ */
