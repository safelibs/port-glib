...
# define SECTION __attribute__ ((section (".gresource.g_plugin"), aligned (sizeof(void *) > 8 ? sizeof(void *) : 8)))
#else
# define SECTION
#endif
...
#ifdef G_DEFINE_CONSTRUCTOR_NEEDS_PRAGMA
#pragma G_DEFINE_CONSTRUCTOR_PRAGMA_ARGS(_g_pluginresource_constructor)
#endif
G_DEFINE_CONSTRUCTOR(_g_pluginresource_constructor)
#ifdef G_DEFINE_DESTRUCTOR_NEEDS_PRAGMA
#pragma G_DEFINE_DESTRUCTOR_PRAGMA_ARGS(_g_pluginresource_destructor)
#endif
G_DEFINE_DESTRUCTOR(_g_pluginresource_destructor)

#else
#warning "Constructor not supported on this compiler, linking in resources will not work"
#endif

static void _g_pluginresource_constructor (void)
{
  g_static_resource_init (&static_resource);
}

static void _g_pluginresource_destructor (void)
{
