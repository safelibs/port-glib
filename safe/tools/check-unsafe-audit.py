...
EXPECTED_UNSAFE_COUNTS = {
    ...
    "crates/gio/src/translated": 19183,
    "crates/girepository/src/exports.rs": 214,
    "crates/girepository/src/runtime.rs": 337,
...
AUDIT_CLASSES = {
    ...
    "crates/gio/src/translated": "Generated Rust translation of upstream C plus final Rust-owned file-monitor/settings polling and D-Bus command-line fallbacks; build-check-only generated modules are excluded.",
    "crates/girepository/src/exports.rs": "Rust-owned GIRepository ABI entrypoints with raw C pointer ingress, GIArgument memory, GType callbacks, and out parameters.",
    "crates/girepository/src/runtime.rs": "Rust-owned GIRepository runtime over GObject type registration, typelib bytes, C string vectors, dlopen/dlsym symbol lookup, stack-loaded GI structs, GIArgument marshaling, and GError out parameters.",
