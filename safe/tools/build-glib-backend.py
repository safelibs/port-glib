#!/usr/bin/env python3
"""Build the replay backend as a differential oracle.

The final safe-glib library no longer links the object produced here into
libglib-2.0.{so,a}; this tool remains useful for side-by-side comparisons and
other diagnostics that still want a renamed upstream implementation.
"""
